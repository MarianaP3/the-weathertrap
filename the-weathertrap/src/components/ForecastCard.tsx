...
import { ArrowDown, CloudRainWind, Droplets, Eye, Sparkles, Sun, Sunset, Waves, Wind } from "lucide-react";
    ...
    <div className="mb-4 eventCardColor text-left rounded-xl bg-card pr-6 pl-6 pt-2.5 pb-3.5 shadow-sm relative overflow-hidden ">
      ...
      <h1 className="text-l font-semibold text-">{title}</h1>      
        ...
        <div className="flex mt-2">
            ...
            <span className="text-sm">Sensación térmica:</span>
        </div>
        <div className="flex mt-2">
        ...
        <div className="flex mt-2">
            ...
            <span className="text-sm">Hora del atardecer:</span>
        </div>
        <div className="flex mt-2">
            <Droplets className="w-4 h-4 mr-1 mt-1" />
        ...
        <div className="flex mt-2">
            <ArrowDown className="w-4 h-4 mr-1 mt-1" />
